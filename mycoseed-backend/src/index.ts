...
import myParticipationsRouter from './routes/myParticipations'
import myPublicationsRouter from './routes/myPublications'
...
app.use('/api/my-payments', myPaymentsRouter) // 我的待付款款项
app.use('/api/my-participations', myParticipationsRouter) // 我报名的活动
app.use('/api/my-publications', myPublicationsRouter) // 我发布的活动
